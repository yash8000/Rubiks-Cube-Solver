//
// Created by srijan on 14-06-2024.
//
#include "BaseRubiksCube.h"

class RubiksCube1dArray : public BaseRubiksCube {
private:
...
public:
    ...
    BaseRubiksCube &uPrime() override {
        this->u();
        this->u();
        this->u();
    ...
    BaseRubiksCube &lPrime() override {
        this->l();
        this->l();
        this->l();
    ...
    BaseRubiksCube &fPrime() override {
        this->f();
        this->f();
        this->f();
    ...
    BaseRubiksCube &rPrime() override {
        this->r();
        this->r();
        this->r();
    ...
    BaseRubiksCube &bPrime() override {
        this->b();
        this->b();
        this->b();
    ...
    BaseRubiksCube &dPrime() override {
        this->d();
        this->d();
        this->d();
